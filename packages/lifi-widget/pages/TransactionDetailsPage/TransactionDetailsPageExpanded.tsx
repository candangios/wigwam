    ...
    <Container sx={{ width: '500px', position: 'relative', marginLeft: '0px', paddingTop: '0', maxHeight: '100%', overflowX: 'hidden', borderRight: '1px solid #21262A' }}>
      ...
      <Card sx={{
        ...
        <Box mt={1}>
          ...
          >
            1ChainAi leverages the advanced Li.Fi swap functionality for seamless asset exchanges. If you require assistance, please use this support ID  and contact them through the link below.
          </Typography>
        </Box>
        <Box mt={1}>
